...
def face_recog_cv(framequeue,l,fn):
    ...
    while(True):
        ...
        if(len(faces)>0): 
            ...
            print(str(fn) + ": found! Count: " + str(count))

            # Draw a rectangle around the faces
            for (x, y, w, h) in faces:
                cv2.rectangle(q, (x, y), (x+w, y+h), (0, 255, 0), 2)

            cv2.imwrite('mgh-f-' + str(count)+'.jpg',q)

def face_recog_fr(framequeue,l,fn):
    ...
    while(True):
        ...
        if(len(faces)>0): 
            ...
            for (top, right, bottom, left) in faces:
                cv2.rectangle(q, (left,top), (right,bottom), (0, 255, 0), 2)
